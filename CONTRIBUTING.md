# Contributing to OAuth2 Proxy

Welcome! Our community focuses on helping others and making OAuth2 Proxy the best it
...
If unique, [open an issue](https://github.com/webhippie/oauth2-proxy/issues)
and answer the questions so we can understand and reproduce the problematic
behavior.

The burden is on you to convince us that it is actually a bug in OAuth2 Proxy. This
...
Please be kind, remember that OAuth2 Proxy comes at no cost to you, and you're
getting free help.
...
resolving issues as you are able to. Thanks for making OAuth2 Proxy amazing!
...
Thanks for your help! OAuth2 Proxy would not be what it is today without your
contributions.
